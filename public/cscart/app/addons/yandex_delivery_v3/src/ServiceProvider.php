...
use Tygh\Addons\YandexDelivery\HookHandlers\PlaceSubordersHookHandler;
...
class ServiceProvider implements ServiceProviderInterface
{
    ...
    public function register(Container $app)
    {
        ...
        $app['addons.yandex_delivery.hook_handlers.place_suborders'] = static function (Application $application) {
            return new PlaceSubordersHookHandler();
        };
    }
