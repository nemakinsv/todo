...
class OrderService
{
    ...
    public function getDeliveryOrderData(array $order_info, array $shipments = [])
    {
         ...
         */
        $partner = isset($shipping['delivery']['delivery']['partner']) ? $shipping['delivery']['delivery']['partner'] : [];
        ...
        return [
            ...
            'type'             => 'WITHDRAW',
            'partner'          => $partner,
            'terms_of_service' => YandexDeliveryService::TERMS_OF_PARTNER_SERVICES,
        ];
    }
