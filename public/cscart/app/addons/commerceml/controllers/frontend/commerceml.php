...
if ($mode === 'catalog_checkauth' || $mode === 'sale_checkauth') {
    ...
    $result = $command_bus->dispatch(
        CreateImportCommand::create([$file_path], $user_data, $import_key, ImportDto::IMPORT_TYPE_CATALOG)
    );
    ...
    $result = $command_bus->dispatch(
        CreateImportCommand::create([$file_path], $user_data, $import_key, ImportDto::IMPORT_TYPE_ORDERS)
    );
