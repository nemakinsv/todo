...
{/foreach}
{if $can_auto_confirm}
    {$title = __("yandex_delivery_v3.add_yandex_order")}
{else}
    {$title = __("yandex_delivery_v3.add_yandex_draft")}
{/if}
<div class="clearfix">
    <div class="hidden" title="{$title}" id="content_add_new_yandex_order_0">
        {include file="addons/yandex_delivery_v3/views/shipments/components/new_yandex_order.tpl"}
