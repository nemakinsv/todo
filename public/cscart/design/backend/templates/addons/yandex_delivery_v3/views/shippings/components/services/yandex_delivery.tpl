<fieldset>
    ...
    <div class="control-group">
        <label class="control-label" class="control-label">{__("weight")} ({$settings.General.weight_symbol}):</label>
        <div class="controls">
            <input id="ship_length" type="text" name="shipping_data[service_params][weight]" size="30" value="{$shipping.service_params.weight}" />
        </div>
    </div>
