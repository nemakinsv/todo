{if $is_yandex_checkout_for_marketplaces_used && !$runtime.company_id}
    ...
    <div class="control-group">
        <label class="control-label" for="agent_type_{$runtime.company_id}">{__("yandex_checkout.agent_type")}:</label>
        <div class="controls">
            <select name="company_data[yandex_checkout_agent_type]" id="agent_type_{$runtime.company_id}">
                <option value="">{__("none")}</option>
                {foreach $agent_types as $agent_type}
                    <option value="{$agent_type}"{if $company_data.yandex_checkout_agent_type === $agent_type} selected="selected"{/if}>{__("yandex_checkout.agent_type.`$agent_type`")}</option>
                {/foreach}
            </select>
        </div>
    </div>
